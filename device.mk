...
# Bluetooth (LDAC)
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/audio/bluetooth/ldac/lib/libldacBT_abr.so:$(TARGET_COPY_OUT_SYSTEM)/lib/libldacBT_abr.so \
    $(LOCAL_PATH)/configs/audio/bluetooth/ldac/lib/libldacBT_enc.so:$(TARGET_COPY_OUT_SYSTEM)/lib/libldacBT_enc.so \
    $(LOCAL_PATH)/configs/audio/bluetooth/ldac/lib64/libldacBT_abr.so:$(TARGET_COPY_OUT_SYSTEM)/lib64/libldacBT_abr.so \
    $(LOCAL_PATH)/configs/audio/bluetooth/ldac/lib64/libldacBT_enc.so:$(TARGET_COPY_OUT_SYSTEM)/lib64/libldacBT_enc.so
...
PRODUCT_SYSTEM_PROPERTIES += dalvik.vm.dex2oat-filter=everything
